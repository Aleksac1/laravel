...
button[type="submit"]:hover{
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
         ...
         <form method="post" action="{{url('users/'.$user->id.'/updateprofile')}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
<br>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Ljeksa {{date("Y")}}</div>
                    </div>
                </div>
            </div>
        </footer>
