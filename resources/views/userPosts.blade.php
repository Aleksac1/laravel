                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <center>
                              @if (auth()->user() && auth()->user()->is_admin == 1 && auth()->user()->id != $user->id)
                    ...
                    <button type="submit" name="submit" class="btn btn-danger btn-outline-secondary" style="border-radius:0;color:black;">Izbrisi korisnika</button>
                            ...
                            <img src="{{asset('storage/slike/'.$user->picture)}}" alt="" style="height:70px;width:70px;border-radius:50%;"><h1 style="margin-top:10px;">{{$user->name}} posts</h1></center>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                {{$user->name }}  on {{$post->published_at}}</small>
              </div>
            </div>
          </div>
